"""Management command to scrape LPGA Tour schedule."""
from datetime import datetime
from django.core.management.base import BaseCommand
from django.db import transaction
from events.models import Tour, Venue, Event
from events.scrapers import LPGAScraper
from events.utils import geocode_venue


class Command(BaseCommand):
    help = 'Scrape and import LPGA Tour schedule'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Starting LPGA Tour scrape for {year}...')
        ...
        if not dry_run:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS('Created LPGA Tour'))
        else:
            tour = None

        try:
            with LPGAScraper(year=year) as scraper:
